...
**一千万以内，最好的远程vibe coding方式！**
选择它，你可以在任何可以使用浏览器的环境，进行远程编程，支持多设备多会话统一管理，支持Claude code / Pi  等CLI，**只要你的编程智能体能运行在tmux中，统统上云！**
配合公网IP，尽享云端丝滑编程！
**手机端适配，无需因为小屏幕产生困扰！**
...
- **左侧边栏（Sessions 模式，默认）**：
  ...
  - 每个会话前面的小圆点显示活动状态：**绿色 = 空闲（idle），橘黄 = 正在干活（working）**（后台自动探测，无需配置，类 herdr 的终端管理体验搬到了云端！）
